...
<qgis version="2.9.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{b873c221-6233-434f-a255-87d77022d8a7}">
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Stein' " key="{ca4a9f53-c868-4b45-8388-36816ea44a45}" symbol="0" label="borne"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Kunststoffzeichen'" key="{1906ba1c-e054-4653-94d5-cf0398940936}" symbol="1" label="borne artificielle "/>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Bolzen' " key="{485f70ed-6b15-4af4-8084-b2d18c963c07}" symbol="2" label="cheville"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Rohr' " key="{2564de36-3cd7-415e-ace8-f8b763f92801}" symbol="3" label="tuyau"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Pfahl'" key="{d00635f0-015b-4e20-8961-2e8bbe96cdad}" symbol="4" label="pieu"/>
      <rule filter=" &quot;punktzeichen_txt&quot; =   'Kreuz' " key="{254cde29-c626-4e68-bf86-a556dfb6be1c}" symbol="5" label="croix"/>
      <rule filter=" &quot;punktzeichen_txt&quot; NOT IN ('Bolzen' , 'Kreuz' , 'Rohr' , 'Stein' )" key="{e236f849-6377-4715-ab41-60d905a7f584}" symbol="6" label="autre"/>
    </rules>
    <symbols>
