...
#                return
            ...
            if not vlayer_points.isValid():
                self.iface.messageBar().pushMessage("Error",  _translate("VeriSO_V+D_Defects", "Could not load defects layer.", None), level=QgsMessageBar.CRITICAL, duration=10)                    
                return
            ...
            if vlayer_points.featureCount() == 0 and vlayer_lines.featureCount() == 0:
                self.iface.messageBar().pushMessage("Information",  _translate("VeriSO_V+D_Defects", "Defects layer are empty.", None), level=QgsMessageBar.INFO, duration=10)                                                    
                return
            ...
            worksheet_points = workbook.add_worksheet( _translate("VeriSO_V+D_Defects", u'Mängelliste (Punkte)', None))
            worksheet_points.set_paper(9)
            worksheet_points.set_portrait()
            
            # Write project name into worksheet.
            worksheet_points.write(0, 0,  _translate("VeriSO_V+D_Defects", "Operat: ", None), fmt_bold)
...
#                types.append(attrs.at(i).type())
            ...
            worksheet_points.write(4, i+1, _translate("VeriSO_V+D_Defects", "Y-Koordinate", None), fmt_italic)
            worksheet_points.write(4, i+2, _translate("VeriSO_V+D_Defects", "X-Koordinate", None), fmt_italic)            
            ...
            worksheet_lines = workbook.add_worksheet( _translate("VeriSO_V+D_Defects", u'Mängelliste (Linien)', None))
            worksheet_lines.set_paper(9)
            worksheet_lines.set_portrait()
            
            # Write project name into worksheet.
            worksheet_lines.write(0, 0,  _translate("VeriSO_V+D_Defects", "Operat: ", None), fmt_bold)
...
#                types.append(attrs.at(i).type())
            ...
            worksheet_lines.write(4, i+1, _translate("VeriSO_V+D_Defects", "Y-Koordinate", None), fmt_italic)
            worksheet_lines.write(4, i+2, _translate("VeriSO_V+D_Defects", "X-Koordinate", None), fmt_italic)            
            worksheet_lines.write(4, i+3, _translate("VeriSO_V+D_Defects", u"Länge [hm]", None), fmt_italic)            
            ...
            self.iface.messageBar().pushMessage("Information",  _translate("VeriSO_V+D_Defects", "Defect(s) written: ", None) + str(filename), level=QgsMessageBar.INFO, duration=10)                                                    
        except Exception, e:
            message = "Error while writing defects file."
            self.iface.messageBar().pushMessage("Error",  _translate("VeriSO_V+D_Defects", message, None), level=QgsMessageBar.CRITICAL, duration=10)       
