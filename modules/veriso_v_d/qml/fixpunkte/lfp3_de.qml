...
<qgis version="2.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{8a08fefd-5321-4022-b899-af6c1c0b714c}">
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Stein' " key="{220576d2-3fde-4933-bb44-06a0d6b5632b}" symbol="0" label="Stein"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Kunststoffzeichen'" key="{86fb2ff7-3e03-411d-ac7e-ba338645ec3e}" symbol="1" label="Kunststoffzeichen"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Bolzen' " key="{81b5cdf0-dad1-475a-803f-7bf8e7a08c9e}" symbol="2" label="Bolzen"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  =  'Rohr' " key="{c9e5a9b8-f12c-474e-9ce6-e8b58af3c0b6}" symbol="3" label="Rohr"/>
      <rule filter=" &quot;punktzeichen_txt&quot;  = 'Pfahl'" key="{224b9aac-2513-4d47-9368-913fa7271c7d}" symbol="4" label="Pfahl"/>
      <rule filter=" &quot;punktzeichen_txt&quot; =   'Kreuz' " key="{0b3b3af5-cdc6-4dc3-aeab-576320782203}" symbol="5" label="Kreuz"/>
      <rule filter=" &quot;punktzeichen_txt&quot; NOT IN ('Bolzen' , 'Kreuz' , 'Rohr' , 'Stein' )" key="{2a37a91d-bca8-4aac-b11d-bca3cc85bb5e}" symbol="6" label="andere "/>
    </rules>
    <symbols>
