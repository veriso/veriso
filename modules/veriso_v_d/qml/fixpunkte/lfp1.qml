...
<qgis version="2.9.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="lfp2_nf_t_ili_tid">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lfp2_nf_nbident">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lfp2_nf_identifikator">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lfp2_nf_beschreibung">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lfp2_nf_gueltigereintrag">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lfp2_nf_datum1">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{4cdf88d9-5886-4222-b321-d68218e771e3}">
      <rule filter=" &quot;begehbarkeit_txt&quot;  =  'begehbar' " key="{97caac29-2891-4d49-97d9-cde1e5e24f91}" symbol="0" label="begehbar"/>
      <rule filter=" &quot;begehbarkeit_txt&quot; = 'nicht_begehbar'" key="{4e66ee31-90f4-47e7-9424-ed11bf4aba50}" symbol="1" label="nicht begehbar"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="color" v="#000000"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="grundbuchplan/symbol_B_lagefixpunkt_1_und_2_nicht_begehbar.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#ffffff"/>
