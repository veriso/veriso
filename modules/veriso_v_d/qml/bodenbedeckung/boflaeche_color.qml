...
<qgis version="2.9.0-Master" minimumScale="-4.65661e-10" maximumScale="-4.65661e-10" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{63628c0b-c6f4-4ec6-8add-84844b1dcb44}">
      ...
      <rule filter="art_txt LIKE 'befestigt.uebrige_befestigte%'" key="{ff2f1c3e-716a-4451-8ec2-827aea4d6748}" symbol="11" label="befestigt.uebrige_befestigte"/>
      <rule filter="art_txt = 'bestockt.geschlossener_Wald'" key="{f265cd68-41f2-4c8c-9777-1a9df8b76d33}" symbol="12" label="bestockt.geschlossener_Wald"/>
      <rule filter="art_txt LIKE 'bestockt.uebrige_bestockte%'" key="{b145fa1d-f57e-4648-905f-a91546d74966}" symbol="13" label="bestockt.uebrige_bestockte "/>
      <rule filter="art_txt LIKE 'humusiert.Acker_Wiese_Weide%'" key="{3a64cd06-18d1-45e8-bce2-45ca3006fed4}" symbol="14" label="humusiert.Acker_Wiese_Weide"/>
      <rule filter="art_txt LIKE 'humusiert.Gartenanlage%'" key="{ee1c99dd-8f41-4307-900c-9cb3fa2f042e}" symbol="15" label="humusiert.Gartenanlage"/>
      <rule filter="art_txt = 'humusiert.Hoch_Flachmoor'" key="{26776fae-45c7-40b8-9fa6-b8fc25adf450}" symbol="16" label="humusiert.Hoch_Flachmoor"/>
      <rule filter="art_txt = 'humusiert.Intensivkultur.Reben'" key="{698bbe6d-8744-441f-86f7-01ab0ff7ef82}" symbol="17" label="humusiert.Intensivkultur.Reben"/>
      <rule filter="art_txt LIKE 'humusiert.Intensivkultur.uebrige_Intensivkultur%'" key="{c5644ae4-2c9c-499b-8e38-fcaf053da455}" symbol="18" label="humusiert.Intensivkultur.uebrige_Intensivkultur"/>
      <rule filter="art_txt = 'humusiert.uebrige_humusierte'" key="{51d764bd-73c0-4ae4-bb37-9e7067fbdff0}" symbol="19" label="humusiert.uebrige_humusierte"/>
      <rule filter="art_txt = 'vegetationslos.Abbau_Deponie%'" key="{337f5f4c-ae91-4f62-a931-4d766e80bd15}" symbol="20" label="vegetationslos.Abbau_Deponie"/>
      <rule filter="art_txt = 'vegetationslos.Fels'" key="{61c753e5-44d0-4a82-b051-1616aeaeccfc}" symbol="21" label="vegetationslos.Fels"/>
      <rule filter="art_txt = 'vegetationslos.Geroell_Sand'" key="{31a428eb-fdc6-4c0e-b71a-db6d06ab4d18}" symbol="22" label="vegetationslos.Geroell_Sand"/>
      <rule filter="art_txt = 'vegetationslos.uebrige_vegetationslose'" key="{c0f37ff1-843d-4eb7-9466-f9dc5981daf4}" symbol="23" label="vegetationslos.uebrige_vegetationslose"/>
    </rules>
    <symbols>
