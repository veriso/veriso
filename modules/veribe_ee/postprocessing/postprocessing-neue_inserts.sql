...
WHERE 
  ST_Intersects (bb.geometrie,ts.geometrie)=true;');
...
INSERT INTO "inserts" VALUES(104,'INSERT INTO $$DBSCHEMA.z_v_bb_ls
SELECT 
  ...
  bodenbedeckung_boflaeche.los, 
  bodenbedeckung_boflaeche.lieferdatum, 
...
WHERE 
  bodenbedeckung_boflaeche.gem_bfs = liegenschaften_liegenschaft.gem_bfs AND
  bodenbedeckung_boflaeche.los = liegenschaften_liegenschaft.los AND
  bodenbedeckung_boflaeche.lieferdatum = liegenschaften_liegenschaft.lieferdatum and
