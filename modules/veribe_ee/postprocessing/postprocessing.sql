...
''4-Schmale bestockte Fläche ab Bodenbedeckung in Einzelobjekte übernehmen'',
...
''8-Flüsse und Seen: Bodenbedeckung anpassen'',
''9-Hochwasserdamm darstellen od. löschen'',
''10-Bauernhof: Gartenanlage od. übrig befestigt anpassen'',
''11-Bauernhof: durchgehenden Weg erfassen'',
''12-Erfassung und/oder Ergänzungen von Gebäudeerschliessungen'',
''13-Erfassung und/oder Ergänzung von grossen Parkplätzen'',
''14-Erfassung und/oder Ergänzung von übrig befestigen Flächen (Einfahrt Einstellhallen)'',
''15-Bahnhof / Station: Bahnsteig erfassen'',
''16-Bereinigung an Gemeinde- oder Losgrenzen (Differenzen zu BB)'',
''17-Einzelobjekte: Bereinigung gemäss Handbuch (Flächen-, Linien- & Symbolobjekte)'',
''18-Löschen von überflüssigen Bodenbedeckungsgrenzen'',
''19-neue BB ausscheiden, BB - Art ändern, BB - Abgrenzung anpassen'',
''20-fehlendes Silo / Wasserbecken / Gebäude etc.'',
''21-fehlende Brücke / Mast / schmaler Weg / eingedohltes Gewässer / Tunnel'',
''22-Gebäude vorhanden / unterierdisch?'',
''23-Bodenbedeckung löschen'',
''24-Diverses''
);
