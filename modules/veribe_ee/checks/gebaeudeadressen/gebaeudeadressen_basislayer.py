...
class ComplexCheck(ComplexCheckBase):
    ...
    def run(self):        
        ...
        if not project_id:
            self.iface.messageBar().pushMessage("Error",  _translate("VeriSO_EE_gebaeudeadressen_basislayer", "project_id not set", None), level=QgsMessageBar.CRITICAL, duration=5)                                
            return
