...
<qgis version="1.7.0-Trunk" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <edittypes>
    <edittype type="0" name="bb_art"/>
    <edittype type="0" name="bb_art_txt"/>
    <edittype type="0" name="bb_geometrie"/>
    <edittype type="0" name="bb_ogc_fid"/>
    <edittype type="0" name="bb_tid"/>
    ...
    <edittype type="0" name="ts_art"/>
    <edittype type="0" name="ts_art_txt"/>
  </edittypes>
  <editform></editform>
